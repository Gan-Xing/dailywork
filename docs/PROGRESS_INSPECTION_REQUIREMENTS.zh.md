...
- 弹窗默认：道路、工种、侧别（G/D/左右由点击行决定）、点击估算的 PK、工序选项。工长填写 PK 起止、工序多选、监理单位、备注。
...
### 8) 状态模型
- 任一可验收单元（PK 区间或 Layer×Step）的通用状态：未处理、验收中、已验收。唯一来源是报检 + 管理员结果；禁止直接改进度值。
