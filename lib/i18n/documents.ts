    ...
    files: {
      ...
      uploadPanel: {
        ...
        entityTypes: {
          ...
          'weekly-plan-item': 'Ligne du plan hebdomadaire',
          other: 'Autre',
        },
        purposes: {
          signature: 'Signature',
          ...
          receipt: 'Bon de réception (receipt)',
      ...
      categories: {
        ...
        'weekly-plan-receipt': 'Bon de réception du plan hebdomadaire',
