...
const dictionaries: Record<DictionaryKind, Record<string, Entry>> = {
  phase: {
    ...
    [normalize('边沟清理')]: { zh: '边沟清理', fr: 'Nettoyage de caniveau' },
    [normalize('Nettoyage de caniveau')]: { zh: '边沟清理', fr: 'Nettoyage de caniveau' },
    [normalize('Caniveau清理')]: { zh: '边沟清理', fr: 'Nettoyage de caniveau' },
  ...
  check: {
    ...
    [normalize('边沟清理验收')]: { zh: '边沟清理验收', fr: 'Réception du nettoyage de caniveau' },
    [normalize('Réception du nettoyage de caniveau')]: {
      zh: '边沟清理验收',
      fr: 'Réception du nettoyage de caniveau',
    },
