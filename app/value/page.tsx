...
type ValueTabKey = 'completion' | 'boq'
...
export default function ValuePage() {
  ...
  const activeTab: ValueTabKey = tabParam === 'boq' ? 'boq' : 'completion'
  ...
  }, [activeTab, copy.completion.messages.loadError, selectedProjectId, unauthorizedMessage])
  ...
  const tabTitle = activeTab === 'boq' ? copy.boq.title : copy.completion.title
  const tabDescription = activeTab === 'boq' ? copy.boq.description : copy.completion.description
  const tabItems = [
