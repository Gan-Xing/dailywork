...
export function MemberFilterDrawer({ 
  ...
  return (
    <div className="relative z-50" aria-labelledby="filter-panel-title" role="dialog" aria-modal="true">
          ...
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            <div className="pointer-events-auto w-screen max-w-md transform transition duration-500 sm:duration-700">
              <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                ...
                <div className="relative flex-1 px-4 py-6 sm:px-6 bg-slate-50/50">
